export function RevenueCard({title,amount,ordercount}){
  ...
  <div className="bg-white rounded shadow-md p-4">
    ...
    <div className="flex justify-between pt-2"> 
      ...
      {ordercount ? <div className="flex text-blue-700 cursor-pointer underline font-medium"><div>{ordercount} order(s)</div><div><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
